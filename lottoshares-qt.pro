...
macx:ICON = src/qt/res/icons/lottoshares.icns
...
macx {
    ...
    sharedrop.files = release/angelshares.txt release/bitcoin.txt release/dogecoin.txt release/memorycoin.txt release/protoshares.txt release/thirtypercent.txt
